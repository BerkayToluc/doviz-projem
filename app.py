...
son_veriler = {
    ...
    "altin": {"GRAM": "...", "CEYREK": "...", "YARIM": "...", "TAM": "...", "ATA": "...", "CUMHURIYET": "...",
              "ONS": "...", "ONS-GUMUS": "..."}
}
...
def verileri_kazi():
    ...
    try:
        # --- 1. KAYNAK: DOVIZ.COM (TIMEOUT 5'E DÜŞÜRÜLDÜ) ---
        ...
        # --- 2. KAYNAK: HAREM ALTIN ---
        try:
            res_harem = requests.get("https://www.haremaltin.com/canli-piyasalar/", headers=headers, timeout=5)
...
@app.route("/")
def index():
    # Sayfa açıldığında veriler '...' görünür, arka planda hemen kazıma başlar
